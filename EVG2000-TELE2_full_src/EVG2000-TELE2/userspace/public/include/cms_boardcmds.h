...
/** Get one of the board's mac address based on id.
 * 
 * @param macAddrNum (OUT) The user must pass in an array of UINT8 of at least
 *                         MAC_ADDR_LEN (6) bytes long.
 * @param id         (IN)  The id used to determine which mac address to get.
 * 
 * @return CmsRet enum.
 */
...
/** Release the specified MAC address back to the board.
 * 
 * @param macAddrNum (IN) An array of MAC_ADDR_LEN bytes long.
 * @return CmsRet enum.
 */
