...
#define AMBIT_SOFTWARE_VERSION     "V1.0.3"
#define AMBIT_UI_VERSION           "1.0.3SingTel"

#else //defined(SingTel)
#define AMBIT_HARDWARE_VERSION     "U12H130T00"
#define AMBIT_SOFTWARE_VERSION     "V0.6.0"
#if (WLAN_REGION == WW_VERSION)
#define AMBIT_UI_VERSION           "0.4.1(VLAN_1)" 
#elif (WLAN_REGION == NA_VERSION)
#define AMBIT_UI_VERSION           "0.1.1NA"
#else
...
#define GPIO_POWER_RED_LED      22
#define GPIO_ETHERNET_LED       24  //use PSTN led as ethernet led since ethernet led is not working now   
#define GPIO_WAN_LED            4

#define GPIO_WPS_BUTTON         35
#define GPIO_WIFI_BUTTON        25
