...
static struct config_keyword keywords[] = {
    ...
    {"oui", read_str, &(server_config.oui), "0014BF"},
    {"serial_num", read_str, &(server_config.serial_num), "1234567890"},
    ...
    {"ip_dect_start",	read_ip,  &(server_config.ip_dect_start),	"192.168.1.191"},
    {"ip_dect_end",	read_ip,  &(server_config.ip_dect_end),		"192.168.1.195"},
    {"stb_start",	read_ip,  &(server_config.stb_start),	    "192.168.1.196"},
    {"stb_end",	    read_ip,  &(server_config.stb_end),		    "192.168.1.203"},
