 ...
 *
 * $Id: wlc_cfg.h,v 1.119.2.17 2009/06/23 09:47:20 Exp $
 */
...
#define BSSCFG_AP(bsscfg)		(1)
#define BSSCFG_STA(bsscfg)		(0)
#elif !defined(AP) && defined(STA)
#define BSSCFG_AP(bsscfg)		(0)
#define BSSCFG_STA(bsscfg)		(1)
#else
#define BSSCFG_AP(bsscfg)		((bsscfg)->_ap)
#define BSSCFG_STA(bsscfg)		(!(bsscfg)->_ap)
#endif /* defined(AP) && !defined(STA) */

/*
 * Macros to check if AP or STA is active.
 * Active AP means more than just configured: driver and BSS are "up";
 * that is, we are beaconing/responding as an AP (aps_associated).
 * Active STA similarly means the driver is up and a configured STA BSS
 * is up: either associated (sta_associated) or trying.
 *
...
#define D11_DEFAULT	0x00ffffb0	/* Supported  D11 revs: 4, 5, 7-23
...
#define GPHY_DEFAULT	0x000003c6	/* Supported gphy revs:
					 ...
					 *	9	4311b0
					 */
#define NPHY_DEFAULT	0x000000ff	/* Supported nphy revs:
					 *	0	4321a0
					 *	1	4321a1
					 *	2	4321b0/b1/c0/c1
					 *	3	4322a0
...
#define SSLPNPHY_DEFAULT	0x0000	/* Supported sslpnphy revs:
					*	0	4329
					*/
...
/* support 2G band */
#if GCONF || NCONF || LPCONF || SSLPNCONF
#define BAND2G
#endif /* GCONF || NCONF || LPCONF || SSLPNCONF */
...
#endif /* defined(BAND5G) && !defined(WL11H) */

#endif 

#if !defined(WME) && defined(WLCAC)
#error	"WME support required"
#endif /* !defined(WME) && defined(WLCAC) */
...
#if !ACONF && !GCONF && !NCONF && !LPCONF && !SSLPNCONF
#error "No PHY configured!"
#endif /* !ACONF && !GCONF && !NCONF && !LPCONF && !SSLPNCONF */
...
#define PHYTYPE (_PHYCONF_A | _PHYCONF_G | _PHYCONF_N | _PHYCONF_LP | _PHYCONF_SSLPN)
...
#define ISNPHY(pi)	PHYTYPE_IS((pi)->phy_type, PHY_TYPE_N)
#define ISLPPHY(pi)	PHYTYPE_IS((pi)->phy_type, PHY_TYPE_LP)
#define ISSSLPNPHY(pi)	PHYTYPE_IS((pi)->phy_type, PHY_TYPE_SSN)
...
#define WLC_MAX_UCODE_BSS	(4)		/* Number of BSS handled in ucode bcn/prb */
#else
...
/* WLLMAC support */
#ifdef WLLMAC
#define LMAC_ENAB(wlc)	1
#else /* WLLMAC */
#define LMAC_ENAB(wlc)	0
#endif /* WLLMAC */
