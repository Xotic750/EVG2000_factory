 ...
 *
 * $Id: d11.h,v 13.443.2.35 2009/06/26 23:19:45 Exp $
 */
...
#define	MI_NOIPACAL_WME		(1 <<  7)	/* Ucode prohibits IPA cal because of WME traffic */
...
/* M_HOST_FLAGS */
#define MHFMAX		4 /* Number of valid hostflag half-word (uint16) */
...
#define MHF4_TKIP_VIVO_WAR	0x0001		/* Change WME timings under certain conditions */
#define MHF4_AGING		0x0008		/* Enable aging threshold for RF awareness */
...
/* CCA Statistics */
#define M_CCA_STATS_BLK (0x3f8 * 2)
...
#if defined(DSLCPE) && defined(DSLCPE_MBSS4)
#define SHM_MBSS_PRS_TPL0        (2 * 0x434)
#else
