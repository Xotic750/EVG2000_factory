 ...
 *
 * $Id: wlioctl.h,v 1.620.2.67 2009/07/05 08:50:50 Exp $
 */
...
#define WLC_LAST				310	/* do not change - use get_var/set_var */
...
#define WL_BTC_DEFAULT		3	/* set the default mode for the device */
...
/* 
   These go to the place of WL_LED_INACTIVE.
   These do not increase WL_LED_NUMBEHAVIOR.
   The command syntax of "wl led" is not changed.
*/

#define WL_LED_USER_OFF 32
#define WL_LED_USER_ON 33
#define WL_LED_USER_BLINK 34
