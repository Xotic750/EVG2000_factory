...
#define ATTADEV
    ...
    if ((arp->ar_op == htons(ARPOP_REQUEST) || arp->ar_op == htons(ARPOP_REPLY))
       ...
       ( (memcmp(dev->name,"br0", 3) == 0) || (memcmp(dev->name,"br1", 3) == 0) || (memcmp(dev->name,"br2", 3) == 0) || (memcmp(dev->name,"br3", 3) == 0)      )) {
...
void __init arp_init(void)
{
    ...
    /* bob added start, 12/30/2008, for attadev */
#ifdef ATTADEV
    {
